...
import com.mostaron.spider.inet.page.Page;
...
public class SpiderMain {
    ...
    public static void main(String...args) throws Exception{
        ...
        GetMethod getMethod = new GetMethod(protocol + host + start_url);
        // 设置 get 请求超时 5s
        ...
        try {
            ...
            page = new Page(responseBody,protocol + host + start_url,contentType); //封装成为页面
